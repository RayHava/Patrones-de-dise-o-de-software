 ...
 * @author hecto
 */
public class ProductoPromocion extends ProductoP {
    ...
    public ProductoPrototype clonar() {
        // Implementación del método clonar para ProductoPromocion (clonación profunda)
        return new ProductoPromocion(
            this.idProducto,
            this.nombre,
            this.cantidad,
            this.precio,
