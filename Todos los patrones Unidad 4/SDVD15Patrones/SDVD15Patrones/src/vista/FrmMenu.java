...
import controlador.ClienteMediator;
import controlador.ClienteMediatorImpl;
...
public class FrmMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem_reportes_ventas_dia = new javax.swing.JMenuItem();
        ...
        jMenuItem_reportes_ventas_dia.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_reportes_ventas_dia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/reporte1.png"))); // NOI18N
        jMenuItem_reportes_ventas_dia.setText("Reportes Ventas Dia");
        jMenuItem_reportes_ventas_dia.setPreferredSize(new java.awt.Dimension(200, 30));
        jMenuItem_reportes_ventas_dia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_reportes_ventas_diaActionPerformed(evt);
            }
        });
        jMenu6.add(jMenuItem_reportes_ventas_dia);
    ...
    private void jMenuItem_nuevo_clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_nuevo_clienteActionPerformed
        ClienteMediator mediator = new ClienteMediatorImpl();
    InterCliente interfazCliente = new InterCliente(mediator);
    
   
    
    // Si usas JDesktopPane:
    jDesktopPane_menu.add(interfazCliente);
    interfazCliente.toFront();
    ...
    private void jMenuItem_gestionar_clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_gestionar_clienteActionPerformed
        // En el menú principal o donde crees las instancias:
ClienteMediator mediator = new ClienteMediatorImpl();

// Para ventana de gestión:
InterGestionarCliente interGestion = new InterGestionarCliente(mediator);
jDesktopPane_menu.add(interGestion);
    interGestion.toFront();
    interGestion.setVisible(true);
...
reportes.ReportesClientes();       // Genera reporte de clientes
    ...
    private void jMenuItem_reportes_ventas_diaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_reportes_ventas_diaActionPerformed
        Reportes reporte = new Reportes();
        reporte.ReportesVentasDia();
    }//GEN-LAST:event_jMenuItem_reportes_ventas_diaActionPerformed
    ...
    private javax.swing.JMenuItem jMenuItem_reportes_ventas_dia;
