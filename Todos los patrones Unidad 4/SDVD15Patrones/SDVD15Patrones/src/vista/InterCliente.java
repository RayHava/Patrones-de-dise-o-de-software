...
public class InterCliente extends javax.swing.JInternalFrame {
    ...
    private void txt_cedulaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cedulaKeyTyped
        soloNumerosYLongitud(evt, txt_cedula, 10);
    }//GEN-LAST:event_txt_cedulaKeyTyped

    private void txt_telefonoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_telefonoKeyTyped
        soloNumerosYLongitud(evt, txt_telefono, 10);
    ...
    private void soloNumerosYLongitud(java.awt.event.KeyEvent evt, javax.swing.JTextField txtField, int longitudMaxima) {
    char c = evt.getKeyChar();
    
    // Permite solo números y asegura que no haya más de 10 caracteres
    if (!Character.isDigit(c) || txtField.getText().length() >= longitudMaxima) {
        evt.consume(); // Evita que el caracter sea ingresado
    }
}
